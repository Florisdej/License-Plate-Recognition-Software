...
# Calculate project root (works from both project root and src/ subdirectory)
...
class LicensePlateDetector:
    ...
    Optimized for Raspberry Pi 4 using OpenVINO runtime.
    """
    ...
    def __init__(
        ...
        imgsz: int = 320,  # Smaller image size for Pi performance
    ):
    ...
    def detect(self, image_source: str | cv2.Mat) -> Tuple[cv2.Mat, List[Dict[str, float]]]:
        ...
        results = self.model(image, imgsz=self.imgsz, device="cpu", verbose=False)[0]
